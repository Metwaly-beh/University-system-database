...
namespace Webapp
{
    public partial class UnpaidApprove : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT L.request_ID, L.date_of_request, L.start_date, L.end_date, L.num_days, L.final_approval_status FROM Leave L INNER JOIN Unpaid_Leave UL ON L.request_ID = UL.request_ID WHERE L.final_approval_status = 'Pending'", conn);
            conn.Open();
